...
\begin{table}[h]
    ...
    \begin{NiceTabular}{c c c c}[hvlines,color-inside]
        ...
        \Block{3-1}{$2023$} & \Block{3-1}{Mingard et al.~\cite{Mingard2023}} & \Block{3-1}{Proponen que las redes neuronales trabajan \\ siguiendo la filosofía de Ockham.} & \Block{3-1}{$13$} \\ \\ \\

        \Block{3-1}{$2023$} & \Block{3-1}{Davies et al.~\cite{Davies2023}} & \Block{3-1}{Plantean unificar el \textit{grokking} y el \\ \textit{double descent} bajo un marco conceptual común.} & \Block{3-1}{$37$} \\ \\ \\
    \end{NiceTabular}
