...
\input{preliminares/informe-directores}   
...
\input{capitulos/fundamentos_matematicos}
\input{capitulos/fundamentos_informaticos}

\part{Estado del Arte}
\input{capitulos/estado_arte}

\part{Análisis Teórico y Empírico}
\input{capitulos/desarrollo_matematico}
\input{capitulos/desarrollo_informatico}

\part{Conclusiones y Trabajos Futuros}
\input{capitulos/conclusiones_trabajosfuturos}
